...
produce docs/informe_estrategias_diarias.md. Jamás consulta la BD.
"""
from __future__ import annotations

from pathlib import Path

from app.models.entities import BalanceEstrategia, PerfilEstrategia
from app.services.diario import matriz_puestos
