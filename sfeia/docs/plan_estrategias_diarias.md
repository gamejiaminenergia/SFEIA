...
> Proyecto: SFEIA · Fecha: 2026-09-09 · Estado: **implementado — informe generado (`docs/informe_estrategias_diarias.md`, k=5, Ene–Jul 2025)**
...
Dado un período de fechas (por defecto **2025-01-01 → 2025-07-31**), determinar para **todos** los comercializadores
...
- Convención de fechas: familia C01–C14 fin **exclusivo** (`fin_c_familia: 2025-08-01`); C15/C16–C18 fin **inclusivo**
  (`fin_c15: 2025-07-31`). Población verificada: **65 agentes**, 48 026 GWh.
...
| `config/config.yaml` | Sección `diario:` (features, k, guardas) + `informe_diario:` + `ventana:` Ene–Jul 2025. |
...
6. Describe comportamiento **pasado** (Ene–Jul 2025), no predicción.